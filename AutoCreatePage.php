...
/**
 * Handles the parser function for appending content to existing pages.
 * It is possible to use &lt;nowiki&gt;
 * in the text parameter to insert verbatim wiki text.
 */
...
/**
 * Appends content to pages that have been requested by the append to page parser function. This is done only
 * after the safe is complete to avoid any concurrent article modifications.
 * Note that article is, in spite of its name, a WikiPage object since MW 1.21.
 */
